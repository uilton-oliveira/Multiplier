...
specific_max_value = {'magic_resistance_pct':'35', 'magic_resistance':'75', 'bonus_magic_resistance':'45', 'bonus_magical_armor':'40', 'spell_resist_pct':'65', 'bonus_spell_resist':'60',
							...
							'kill_pct': '50', 'knockback_min': '500', 'knockback_max': '1000',
							'trueshot_ranged_damage': '200 250 300 350',
							'structure_damage_mod': '0',
							'maim_chance': '50', 'health_regen_rate': '5', 'magic_resistance_aura': '50',
							'blink_range': '4500', 'modelscale': '100', 'model_scale': '100', 'str_scale_up': '10', 'item_smoke_of_deceit': '500'}

more_specific_max_value = {'item_cloak':{'tooltip_resist': '40'}, 'item_hood_of_defiance':{'tooltip_resist': '60'}, 'item_pipe':{'tooltip_resist':'75'}, 'luna_eclipse': {'beams':'20 35 50', 'beams_scepter': '30 40 50', 'beam_interval': '0.3 0.3 0.3'},
							 ...
							 'shadow_shaman_voodoo': {'movespeed': '50'}, 'shadow_shaman_mass_serpent_ward': {'ward_count': '20'},
							 ...
							 'jakiro_ice_path': {'path_delay': '0.1'}, 'leshrac_split_earth': {'delay': '0.18'},
							 'ancient_apparition_ice_vortex': {'movement_speed_pct': ' -32 -43 -54 -65', 'spell_resist_pct': '-60 -90 -120 -150'},
							 'ancient_apparition_ice_blast': {'kill_pct': '40.0'}, 'enchantress_impetus': {'bonus_attack_range_scepter': '700', 'distance_damage_pct': '90.0 100.0 110.0'},
							 'dazzle_weave': {'armor_per_second': '1.75 2 2.25', 'armor_per_second_scepter': '2.25 2.5 2.75'},
							 'phoenix_fire_spirits': {'spirit_count': '20'}, 'phoenix_sun_ray': {'ally_heal': '2'},
							 'phoenix_launch_fire_spirit': {'spirit_count': '20'},
							 'oracle_fates_edict': {'damage_amp': '500'}, 'witch_doctor_paralyzing_cask': {'speed': '1800'},
							 ...
							 'lycan_feral_impulse': {'bonus_damage': '30 40 50 60', 'bonus_attack_speed': '20 30 40 50'}, 'item_diffusal_blade': {'feedback_mana_burn': '300', 'damage_per_burn': '3.0'},
							 ...
							 'chen_penitence': {'bonus_damage_taken': '150'}, 'chen_holy_persuasion': {'max_units': '20'},
							 ...
							 'techies_stasis_trap': {'explode_delay': '0.5', 'activation_time': '0.5', 'fade_time': '0.5'}, 'techies_suicide': {'damage': '5000 6500 8500 11500', 'partial_damage': '2600 3000 3400 3800'},
							 'techies_remote_mines': {'activation_time': '0.5', 'damage': '2500 3500 4000'},
							 'item_veil_of_discord': {'resist_debuff': '-60'}, 'item_ethereal_blade': {'ethereal_damage_bonus': '-180'},
							 'doom_bringer_lvl_death': {'lvl_bonus_damage': '50'}, 'doom_bringer_devour': {'bonus_gold': '300 400 500 600'},
							 'item_hand_of_midas': {'bonus_gold': '1000', 'xp_multiplier': '10', 'bonus_attack_speed': '100'}, 'ogre_magi_fireblast': {'multicast_delay': '1'},
							 'ogre_magi_unrefined_fireblast': {'multicast_delay': '1'},
							 'ogre_magi_ignite': {'slow_movement_speed_pct': '-60', 'multicast_delay': '0.2'},
							 'ogre_magi_bloodlust': {'modelscale': '50'}, 'silencer_glaives_of_wisdom': {'intellect_damage_pct': '60 80 100 120'},
							 ...
							 'templar_assassin_refraction': {'instances':'3 6 10 16'}, 'templar_assassin_meld': {'bonus_armor': '-30'},
							 ...
							 'item_glimmer_cape': {'active_magical_armor': '100'}, 'abaddon_death_coil': {'self_damage': '450'},
							 ...
							 'item_quelling_blade': {'damage_bonus': '400', 'damage_bonus_ranged': '350'}, 'item_bfury': {'quelling_bonus': '450', 'quelling_bonus_ranged': '400', 'cleave_damage_percent': '50'},
							 ...
							 'troll_warlord_whirling_axes_ranged': {'axe_range': '1500'}, 'troll_warlord_whirling_axes_melee': {'max_range': '950'},
							 ...
							 'earthshaker_enchant_totem': {'totem_damage_percentage': '1000 1500 2000 2500'}, 'medusa_split_shot': {'arrow_count': '4 6 8 10'},
							 ...
							 'nyx_assassin_burrow': {'damage_reduction': '90'},
...
multiply_all_partial_by_fixed_factor = {'_radius': 2.5, '_width': 2.5, 'radius_': 2.5, '_radius_tooltip': 2.5, '_distance': 2.5, '_length': 2.5, '_aoe': 2.5, 'cast_range_tooltip': 2, '_range': 2, 'projectile_speed': 3}
...
ignore_special = {'pudge_meat_hook':{'hook_width'}, 'faceless_void_time_lock':{'duration'},
									...
									'enigma_malefice': {'stun_duration', 'tick_rate', 'tooltip_stuns'}, 'enigma_black_hole': {'duration'},
									'enchantress_natures_attendants': {'heal_interval'}, 'ember_spirit_sleight_of_fist': {'creep_damage_penalty', 'attack_interval'},
									'ember_spirit_flame_guard': { 'tick_interval'}, 'ember_spirit_fire_remnant': {'charge_restore_time'},
									'ember_spirit_activate_fire_remnant': {'charge_restore_time'}, 'earthshaker_fissure': {'fissure_duration', 'stun_duration'},
									'crystal_maiden_freezing_field': {'explosion_interval', 'explosion_min_dist', 'explosion_max_dist'},
									'rattletrap_power_cogs': { 'spacing', 'duration'}, 'rattletrap_battery_assault': {'interval',  'duration'},
									'dark_seer_ion_shell': {'duration'}, 'necrolyte_heartstopper_aura': {'aura_damage'}, 'axe_battle_hunger': {'duration'},
									'doom_bringer_doom': {'duration', 'duration_scepter', 'deniable_pct'}, 'doom_bringer_lvl_death': {'lvl_bonus_multiple'},
									'doom_bringer_scorched_earth': { 'duration'}, 'dazzle_shallow_grave':{'duration_tooltip'}, 
									...
									'brewmaster_primal_split': {'split_duration'}, 'sniper_shrapnel': {'duration', 'damage_delay', 'slow_duration'},
									'death_prophet_exorcism': {'spirit_speed'},
									'alchemist_acid_spray': {'duration'}, 'alchemist_chemical_rage': {'duration', 'bonus_movespeed', 'transformation_time'}, 'spirit_breaker_greater_bash': {'chance_pct', 'duration'},
									'alchemist_goblins_greed': {'bonus_gold', 'bonus_bonus_gold'}, 'weaver_shukuchi': { 'fade_time'}, 'sniper_headshot': {'stun_duration', 'proc_chance'},
									...
									'rubick_telekinesis': { 'lift_duration', 'stun_duration', 'fall_duration'}, 'rubick_fade_bolt': {'duration', 'slow_duration', 'jump_damage_reduction_pct',  'jump_delay'},
									'leshrac_pulse_nova': { 'mana_cost_per_second'}, 'leshrac_lightning_storm': {'slow_duration'}, 'leshrac_diabolic_edict': { 'num_explosions'},
									'leshrac_split_earth': {'duration'}, 'rattletrap_hookshot': {'duration'}, 'ursa_overpower': {'duration_tooltip'},
									'dragon_knight_frost_breath': {'duration'}, 'drow_ranger_silence': {'duration'}, 'drow_ranger_wave_of_silence': {'silence_duration', 'wave_range_tooltip'},
									...
									'bloodseeker_thirst': {'visibility_threshold_pct', 'invis_threshold_pct', 'max_bonus_pct'},
									'wisp_overcharge': {'drain_interval', 'drain_pct', 'drain_pct_tooltip', 'bonus_damage_pct'}, 'wisp_spirits': {'min_range', 'max_range', 'spirit_duration'},
									'lion_impale': {'duration'}, 'lion_voodoo': {'duration', 'movespeed'}, 'lion_mana_drain': {'duration', 'illusion_kill_time', 'tick_interval'},
									'luna_eclipse': {'duration_tooltip', 'duration_tooltip_scepter'},
									'lina_light_strike_array': {'light_strike_array_delay_time'}, 'magnataur_empower': {'empower_duration'},
									'magnataur_skewer': {'slow_duration'}, 'magnataur_reverse_polarity': {'pull_duration'},
									'medusa_stone_gaze': {'duration', 'stone_duration', 'face_duration', 'vision_cone'},
									'medusa_mystic_snake': {'snake_scale', 'jump_delay'}, 'morphling_replicate': {'duration'},
									...
									'clinkz_death_pact': {'damage_gain_pct', 'duration'}, 'clinkz_wind_walk': {'duration"'},
									'clinkz_strafe': {'duration'}, 'warlock_upheaval': {'duration'},
									'troll_warlord_whirling_axes_ranged': {'axe_width', 'axe_spread', 'axe_count', 'axe_slow_duration'}, 'troll_warlord_berserkers_rage': {'bash_duration', 'bonus_move_speed', 'bonus_armor'},
									'tiny_avalanche': {'num_ticks'}, 'tiny_toss': {'duration', 'grab_radius', 'bonus_damage_pct', 'grow_bonus_damage_pct'},
									...
									'razor_static_link': {'drain_duration', 'drain_range',  'speed', 'vision_duration'}, 'razor_eye_of_the_storm': {'duration', 'strike_interval'},
									...
									'undying_tombstone_zombie_deathstrike': {'duration'}, 'undying_flesh_golem': {'duration'}, 'disruptor_thunder_strike': { 'strike_interval', 'duration'},
									'disruptor_glimpse': {'backtrack_time'}, 'disruptor_kinetic_field': { 'duration'}, 'disruptor_static_storm': { 'duration', 'duration_scepter', 'pulses', 'pulses_scepter'},
									'nyx_assassin_impale': {'duration'}, 'nyx_assassin_vendetta': {'duration'}, 'naga_siren_ensnare': {'duration'},
									'naga_siren_song_of_the_siren': {'duration', 'animation_rate'},
									'keeper_of_the_light_illuminate': { 'max_channel_time', 'channel_vision_interval'}, 'keeper_of_the_light_mana_leak': {'duration'},
									...
									'zuus_arc_lightning': { 'jump_delay', 'jump_count'}, 'zuus_lightning_bolt': {'sight_duration'},
									'zuus_static_field': {'damage_health_pct'}, 'puck_illusory_orb': {'orb_vision', 'vision_duration'},
									...
									'night_stalker_darkness': {'blind_percentage'}, 'riki_smoke_screen': {'miss_rate'}, 'riki_backstab': {'backstab_angle', 'damage_multiplier'},
									'mirana_starfall': {'starfall_secondary_radius'}, 'enigma_midnight_pulse': {'duration'},
									...
									'phoenix_supernova': {'tooltip_duration', 'stun_duration'}, 'phoenix_fire_spirits': {'spirit_duration',  'duration', 'tick_interval'},
									'phoenix_icarus_dive': {'hp_cost_perc', 'burn_duration', 'burn_tick_interval'},
									'phoenix_sun_ray': { 'forward_move_speed', 'turn_rate_initial', 'turn_rate', 'tooltip_duration', 'tick_interval'}, 'obsidian_destroyer_arcane_orb': {'mana_pool_damage_pct'},
									...
									'silencer_glaives_of_wisdom': {'steal_range'}, 'silencer_last_word': {'duration', 'debuff_duration'},
									...
									'shadow_demon_shadow_poison': { 'tooltip_duration'}, 'shadow_demon_soul_catcher': { 'tooltip_duration'},
									'shadow_demon_demonic_purge': {'tooltip_duration', 'charge_restore_time'}, 'tusk_ice_shards': {'shard_width', 'shard_count', 'shard_duration', 'shard_angle_step'},
									'tusk_snowball': {'snowball_windup', 'snowball_duration'}, 'enigma_demonic_conversion': {'eidolon_dmg_tooltip', 'eidolon_hp_tooltip'},
									'furion_force_of_nature': {'duration', 'max_treants'}, 'furion_wrath_of_nature': {'damage_percent_add'},
									'invoker_ghost_walk': {'duration', 'self_slow', 'aura_fade_time'},
									'invoker_cold_snap': {'duration', 'freeze_cooldown', 'damage_trigger'},
									'invoker_tornado': {'end_vision_duration', 'lift_duration'}, 'invoker_emp': {'delay', 'damage_per_mana_pct'},
									'invoker_chaos_meteor': {'land_time', 'damage_interval', 'end_vision_duration', 'burn_duration'},
									'invoker_sun_strike': {'vision_duration'}, 'invoker_forge_spirit': {'spirit_duration', 'spirit_attack_range', 'spirit_mana', 'spirit_hp'},
									...
									'broodmother_spawn_spiderlings': {'count'}, 'broodmother_spin_web': { 'fade_delay', 'damage_time', 'charge_restore_time'}, 'weaver_the_swarm': {'attack_rate', 'count'},
									...
									'item_soul_ring': {'health_sacrifice'}, 'tiny_grow': {'bonus_movement_speed', 'bonus_attack_speed', 'bonus_building_damage_scepter', 'grow_bonus_damage_pct', 'grow_bonus_damage_pct_scepter'},
									'visage_soul_assumption': {'stack_limit', 'stack_duration'}, 'visage_gravekeepers_cloak': {'max_layers', 'recovery_time'},
									'slark_dark_pact': { 'pulse_duration', 'delay', 'total_pulses', 'pulse_interval'}, 'slark_shadow_dance': {'bonus_movement_speed', 'bonus_regen_pct', 'neutral_disable'},
									'tusk_frozen_sigil': {'sigil_duration', 'move_slow', 'attack_slow'}, 'tusk_walrus_punch': {'hp_threshold', 'air_time', 'move_slow'},
									'abaddon_borrowed_time': {'hp_threshold'}, 'batrider_flamebreak': {'knockback_height'},
									'axe_counter_helix': {'cooldown', 'trigger_chance'}, 'kunkka_tidebringer': {'cleave_damage'},
									'beastmaster_wild_axes': { 'spread'},
									'jakiro_macropyre': {'burn_interval'},
									'alchemist_unstable_concoction': {'brew_time',  'brew_explosion'}, 'alchemist_unstable_concoction_throw': {'brew_time'},
									'brewmaster_earth_pulverize': {'radius_inner', 'radius_outer'},
									'centaur_stampede': { 'strength_damage'}, 'skywrath_mage_concussive_shot': {'shot_vision', 'vision_duration', 'movement_speed_pct', 'slow_duration'},
									...
									'abyssal_underlord_firestorm': { 'wave_interval', 'burn_interval', 'first_wave_delay'}, 'abyssal_underlord_pit_of_malice': { 'pit_interval', 'pit_duration'},
									'abyssal_underlord_atrophy_aura': { 'bonus_damage_duration'}, 'abyssal_underlord_dark_rift': { 'teleport_delay'},
									'oracle_fortunes_end': {'minimum_purge_duration', 'maximum_purge_duration', 'max_channel_time_tooltip'}, 'backdoor_protection': { 'activation_time'}, 'backdoor_protection_in_base': {'activation_time'},
									'techies_stasis_trap': {'duration'}, 'winter_wyvern_arctic_burn': {'attack_range_bonus': '475 575 675 775'},
									'techies_suicide': {'respawn_time_percentage', 'respawn_time_percentage_tooltip'},
									'techies_remote_mines': {'duration', 'model_scale'},
									'queenofpain_sonic_wave': {'starting_aoe'}, 'pudge_rot': {'rot_tick'}, 'pudge_dismember': {'strength_damage_scepter'},
									...
									'lina_dragon_slave': {'dragon_slave_width_initial'}, 'lina_fiery_soul': {'fiery_soul_attack_speed_bonus', 'fiery_soul_move_speed_bonus'},
									'enraged_wildkin_tornado': {'duration'},
									'satyr_hellcaller_shockwave': {'radius_start', 'radius_end'}, 'harpy_storm_chain_lightning': {'jump_range', 'damage_percent_loss'},
									...
									'elder_titan_natural_order': { 'armor_reduction_pct'}, 'dark_seer_vacuum': {'radius_tree'},
									...
									'slark_pounce': {'pounce_acceleration'}, 'item_gloves': {'bonus_attack_speed'}, 'beastmaster_primal_roar': {'push_duration', 'slow_duration', 'cooldown_scepter'},
									'necrolyte_reapers_scythe': {'respawn_constant', 'respawn'}, 'morphling_adaptive_strike': {'stun_min', 'stun_max', 'knockback_min', 'knockback_max'},
									'warlock_golem_flaming_fists': {'chance'}, 'skywrath_mage_arcane_bolt': {'bolt_vision'}, 'skywrath_mage_ancient_seal': {'resist_debuff'},
									'earth_spirit_stone_caller': {'charge_restore_time', 'max_charges'}, 'axe_culling_blade': {'speed_duration'},
									'sandking_caustic_finale': {'caustic_finale_damage_reduced'}, 'jakiro_liquid_fire': { 'tooltip_duration'},
									'ancient_apparition_cold_feet': {'stun_duration'}, 'forged_spirit_melting_strike': {'duration'}, 'templar_assassin_self_trap': {'movement_speed_bonus_stage'},
									'venomancer_venomous_gale': {'duration', 'tick_interval'}, 'venomancer_poison_sting': {'movement_speed'}, 'venomancer_plague_ward': {'ward_hp_tooltip', 'ward_damage_tooltip'},
									'venomancer_poison_nova': {'duration', 'duration_scepter'}, 'phoenix_launch_fire_spirit': {'spirit_duration',  'duration', 'tick_interval'},
									...
									'lycan_summon_wolves': {'wolf_index', 'wolf_duration', 'wolf_damage', 'wolf_hp', 'wolf_bat'}, 'bounty_hunter_track': {'gold_steal'},
									...
									'templar_assassin_psionic_trap': {'trap_fade_time'}, 'templar_assassin_trap': {'trap_duration', 'movement_speed_bonus_stage'},
									'templar_assassin_self_trap': {'trap_duration', 'movement_speed_bonus_stage'}, 'storm_spirit_ball_lightning': {'blocker_duration', 'ball_lightning_move_speed', 'AbilityDamage'},
									'spectre_haunt': {'attack_delay', 'tooltip_illusion_total_damage_incoming'}, 'item_bloodstone': {'charge_range', 'respawn_time_reduction'},
...
ignore_normal = {'dazzle_shallow_grave':{'AbilityDuration'}, 'dazzle_poison_touch': {'AbilityDuration'},
								 ...
								 'phoenix_supernova': {'AbilityDuration'}, 'obsidian_destroyer_astral_imprisonment': {'AbilityDuration'},
								 'meepo_geostrike': {'AbilityDuration'}, 'witch_doctor_maledict': {'AbilityDuration'},
								 'shadow_demon_disruption': {'AbilityDuration'},
								 'bloodseeker_rupture': {'AbilityCastRange'}, 'bloodseeker_blood_bath': {'AbilityCastRange'},
